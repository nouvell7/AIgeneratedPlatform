...
import { codespacesService, CodespaceConfig } from '../services/codespaces.service';
...
export class CodespacesController {
  ...
  async createCodespace(req: Request, res: Response) {
    try {
      ...
      const codespace = await codespacesService.createCodespace(owner, repo, config);
  ...
  async getCodespace(req: Request, res: Response) {
    try {
      ...
      const codespace = await codespacesService.getCodespace(codespaceId);
  ...
  async startCodespace(req: Request, res: Response) {
    try {
      ...
      const codespace = await codespacesService.startCodespace(codespaceId);
  ...
  async stopCodespace(req: Request, res: Response) {
    try {
      ...
      const codespace = await codespacesService.stopCodespace(codespaceId);
  ...
  async getAvailableMachines(req: Request, res: Response) {
    try {
      ...
      const machines = await codespacesService.getAvailableMachines(owner, repo);
...
export const codespacesController = new CodespacesController();